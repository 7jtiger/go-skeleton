...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/dm/v01/history/{room_id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "messages, total_count, next_cursor, has_more, my_last_mid, partner_last_mid",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/dm/v01/rinfo/{room_id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "채팅방 ID (chat_his.idx)",
                        "name": "room_id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "방 입장 시 마지막으로 읽은 메시지 mid (없으면 최신 메시지로 갱신)",
                        "name": "mid",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "room_id, room, my_last_mid, partner_last_mid",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/dm/v01/upload/img": {
            "post": {
                ...
                "description": "인증된 사용자가 채팅에 이미지를 업로드합니다. 이미지는 Cloudflare Images에 저장되며, 여러 장(최대 5장, 각 5MB 이하) 업로드 가능. 업로드 성공 시 Cloudflare 이미지 URL 목록 반환 (data에 포함).\n요청 예시(curl):\ncurl -X POST \"http://localhost:8080/dm/v01/upload/img\" -H \"Authorization: Bearer {jwt-access-token}\" -F \"file=@/home/tmp/chat1.jpg\" -F \"file=@/home/tmp/chat2.jpg\"\n성공 응답 예시:\n{\"result\":0,\"resultString\":\"Success\",\"data\":{\"msg\":\"success\",\"data\":{\"chat1.jpg\":\"https://imagedelivery.net/.../public\",\"chat2.jpg\":\"https://imagedelivery.net/.../public\"}}}\n실패 응답 예시(400): {\"error\":\"file required\"}\n실패 응답 예시(401): {\"error\":\"User not authenticated\"}\n실패 응답 예시(500): {\"error\":\"Failed to upload image\"}",
                "consumes": [
                    "multipart/form-data"
                ],
                "produces": [
        ...
        "/story/v01/comment/{idx}/{page}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved story comments - returns {comment_list, total_count}",
                        "schema": {
                            "$ref": "#/definitions/protocol.RespDataHeader"
                        }
                    },
        ...
        "/story/v01/create": {
            "post": {
                ...
                "description": "JWT 인증 사용자의 스토리를 DB에 저장합니다. 미디어 파일은 직접 받지 않고, **업로드 API의 data.media**를 전달합니다.\n\n**권장 플로우**\n1. ` + "`" + `POST /story/v01/upload` + "`" + ` — Cloudflare 업로드 → ` + "`" + `data.media` + "`" + ` 수신\n2. ` + "`" + `POST /story/v01/create` + "`" + ` — JSON body에 ` + "`" + `media` + "`" + `(upload 응답 객체) 전달\n\n**media 슬롯**: 최대 5개. ` + "`" + `{\"1\":{\"type\":\"img\",\"url\":\"...\"},\"2\":{\"type\":\"vdo\",\"url\":\"...\",\"thumb\":\"...\"}}` + "`" + `\n**stat**: 0=del, 1=pub, 2=private(팔로우공개), 3=limit(유료공개), 4=resv\n",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "JSON 파싱 실패, media 누락, 프로필 필드 부족",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/story/v01/cutout/cancel/{tid}": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "cutout 해제 대상 사용자 UID",
                        "name": "tid",
                        "in": "path",
                        "required": true
                    }
        ...
        "/story/v01/cutout/list/{page}/{limit}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "페이지 크기(기본 4, 최대 100)",
                        "name": "limit",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "msg, total_count, list",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/story/v01/cutout/set/{tid}": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "tid invalid / self cutout / target user not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/story/v01/detail/{idx}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved story detail - str_img is unified media slot map",
                        "schema": {
                            "$ref": "#/definitions/protocol.RespDataHeader"
                        }
                    },
        ...
        "/story/v01/like/toggle": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Story like toggle request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/protocol.StoryLikeToggleReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Successfully toggled story like",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/story/v01/list/{uid}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved story list - str_img is unified media slot map",
                        "schema": {
                            "$ref": "#/definitions/protocol.RespDataHeader"
                        }
                    },
        ...
        "/story/v01/prf/assets": {
            "get": {
                ...
                "description": "JWT 인증 사용자 본인의 보유 화살(포인트), 캐시, DM 미읽음 쪽지 합계를 조회합니다.\n\n**응답 data**\n- ` + "`" + `hold_point` + "`" + `: 보유 화살/포인트 (` + "`" + `user_info.hold_point` + "`" + `, NULL이면 0)\n- ` + "`" + `hold_cash` + "`" + `: 보유 캐시 (` + "`" + `user_info.hold_cash` + "`" + `, NULL이면 0)\n- ` + "`" + `msg_count` + "`" + `: 전체 DM 미읽음 쪽지 합계 (Redis)",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    "200": {
                        "description": "data.hold_point, data.hold_cash, data.msg_count",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/story/v01/prf/info": {
            "get": {
                ...
                "description": "JWT 인증 후 본인 또는 타인의 프로필 정보와 팔로워 수를 조회합니다.\n\n**tid**: 조회 대상 UID. 비어 있으면 JWT 본인 UID 사용. 값이 있으면 해당 사용자 프로필 조회.\n**응답 data**: ` + "`" + `prf_Info` + "`" + `(protocol.PrfInfo), ` + "`" + `flw_cnt` + "`" + `(팔로워 수)",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    "200": {
                        "description": "data.prf_Info, data.flw_cnt",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/story/v01/prf/info/{tid}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "조회 대상 UID (본인 조회 시에도 UID 전달)",
                        "name": "tid",
                        "in": "path",
                        "required": true
                    }
        ...
        "/story/v01/prf/pic/delete/{idx}": {
            "post": {
                ...
                "description": "JWT 인증 사용자의 ` + "`" + `prf_info.sub_pic{slot}` + "`" + `를 삭제하고, 뒤 슬롯을 앞으로 당깁니다.\n\n**idx**(path): 삭제할 슬롯 번호 1~5. 예: 2 → sub_pic2 삭제 후 sub_pic3→2, sub_pic4→3, sub_pic5→4, sub_pic5=NULL\n슬롯 JSON은 ` + "`" + `{\"url\",\"stat\"}` + "`" + `만 저장(idx 없음). 순번은 컬럼 위치.\n**응답**: ` + "`" + `SendResponse` + "`" + ` — ` + "`" + `desc=success` + "`" + ` (data 필드 없음)",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    "200": {
                        "description": "result=0, desc=success",
                        "schema": {
                            "$ref": "#/definitions/protocol.RespHeader"
                        }
                    },
                    "400": {
                        "description": "idx 누락/형식 오류",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/story/v01/prf/pic/list": {
            "get": {
                ...
                "description": "JWT 인증 후 프로필 사진(` + "`" + `prf_info.sub_pic1` + "`" + `~` + "`" + `sub_pic5` + "`" + `) 목록을 조회합니다.\n\n**조회 대상**: 현재 라우트는 ` + "`" + `/prf/pic/list` + "`" + ` (본인 JWT UID). 코드상 ` + "`" + `tid` + "`" + ` path가 있으면 해당 UID 조회.\n**응답 data**: 비어 있지 않은 슬롯만 포함한 맵\n` + "`" + `{\"1\":{\"url\":\"...\",\"stat\":3},\"2\":{\"url\":\"...\",\"stat\":3}}` + "`" + ` (키=` + "`" + `sub_pic` + "`" + ` 번호)\n\n**PrfPicInfo.stat**: 1=요청중, 2=승인대기, 3=승인, 4=거절/삭제",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/story/v01/prf/pic/stat": {
            "post": {
                ...
                "description": "승인 대기 목록(` + "`" + `GetPrfPicWaitingList` + "`" + `)의 특정 항목을 승인합니다. ` + "`" + `prf_info.sub_pic{slot}` + "`" + ` JSON의 ` + "`" + `stat` + "`" + `을 **3(승인)** 으로 변경합니다.\n\n**요청 body**: ` + "`" + `uid` + "`" + `(대상 사용자), ` + "`" + `slot` + "`" + `(1~5, sub_pic 슬롯)\n**조건**: 해당 슬롯의 현재 stat이 1 또는 2일 때만 갱신\n**응답 data**: ` + "`" + `msg` + "`" + `, ` + "`" + `affected` + "`" + ` (0이면 대상 없음/이미 처리됨)",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "description": "승인 대상 uid + slot",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/protocol.SetPrfPicStatReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/story/v01/prf/pic/upload": {
            "post": {
                ...
                "description": "JWT 인증 사용자의 프로필 사진을 Cloudflare Images에 업로드하고 ` + "`" + `prf_info.sub_pic1~5` + "`" + `에 저장합니다.\n\n**요청 (multipart/form-data)**\n- ` + "`" + `files` + "`" + `: 신규 이미지 (JPG/PNG/GIF/WEBP, 각 ≤5MB, 최대 5개). **thbnl 금지**(이미지 전용).\n- ` + "`" + `urls` + "`" + `: 유지할 기존 사진 URL JSON 배열 문자열. 신규만이면 ` + "`" + `[]` + "`" + `.\n\n**처리 순서**\n1. ` + "`" + `urls` + "`" + ` 기존 URL을 앞에서부터 채움 (stat=3 승인)\n2. ` + "`" + `files` + "`" + ` 신규 업로드 URL을 이어 붙임 (stat=1 요청중)\n3. 합계 최대 5장. 순차적으로 ` + "`" + `sub_pic1` + "`" + `~` + "`" + `sub_picN` + "`" + `에 ` + "`" + `{\"url\",\"stat\"}` + "`" + ` JSON 저장 (idx 없음)\n\n**PrfPicInfo.stat**: 1=요청중, 2=승인대기, 3=승인, 4=거절/삭제\n\"stat\" Enums(1(요청중),2(승인대기),3(승인),4(거절/삭제)) default(1)\n\n**응답 data**: ` + "`" + `msg` + "`" + `, ` + "`" + `pics` + "`" + `([]PrfPicInfo — url/stat만, 배열 순서=슬롯)",
                "consumes": [
                    "multipart/form-data"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "신규 프로필 이미지 (최대 5개, 이미지 전용)",
                        "name": "files",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "유지할 기존 URL JSON 배열. 예: [] 또는 [\\",
                        "name": "urls",
                        "in": "formData"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "data.msg, data.pics",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "파일 없음, urls JSON 오류, 저장할 사진 없음",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "500": {
                        "description": "Cloudflare/DB 저장 실패",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/story/v01/prf/pic/waiting/{page}/{limit}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/story/v01/prf/set/mainpic/{url}": {
            "post": {
                ...
                "description": "JWT 인증 사용자의 ` + "`" + `prf_info.main_pic` + "`" + `을 설정하거나 삭제합니다.\n\n**url path**\n- 값이 있으면 해당 URL을 대표사진으로 저장\n- 비어 있으면 대표사진 삭제(` + "`" + `main_pic` + "`" + ` 빈 문자열)\n- URL에 ` + "`" + `/` + "`" + `가 포함되면 path-escape 필요 (예: ` + "`" + `url.PathEscape` + "`" + `)\n\n**응답 data**: ` + "`" + `{\"msg\":\"success\"}` + "`" + `",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "대표사진 URL (삭제 시 빈 값 또는 placeholder)",
                        "name": "url",
                        "in": "path",
                        "required": true
                    }
        ...
        "/story/v01/prf/story/lists": {
            "get": {
                ...
                "description": "JWT 인증 후 본인 또는 타인의 최신 스토리 최대 4개의 대표 미디어 URL을 조회합니다.\n\n**tid**: 조회 대상 UID. 비어 있으면 JWT 본인 UID 사용.\n**응답 data**\n- ` + "`" + `str_imgs` + "`" + `: 이미지 스토리 대표 URL 맵 (key=story idx, value=URL)\n- ` + "`" + `str_thmbls` + "`" + `: 동영상 스토리 썸네일 URL 맵 (key=story idx, value=thumb URL)",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    "200": {
                        "description": "data.str_imgs, data.str_thmbls",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/story/v01/prf/upd": {
            "post": {
                ...
                "description": "JWT 인증 사용자의 ` + "`" + `prf_info` + "`" + `를 부분 수정합니다. UID는 JWT에서 강제 설정합니다.\n\n**요청 body** (` + "`" + `protocol.PrfInfo` + "`" + `): 값이 있는 필드만 UPDATE (빈 문자열은 무시)\n- ` + "`" + `nick` + "`" + `, ` + "`" + `gender` + "`" + `, ` + "`" + `age` + "`" + `, ` + "`" + `area` + "`" + `, ` + "`" + `intro` + "`" + `\n- ` + "`" + `uid` + "`" + ` / ` + "`" + `birth` + "`" + ` / ` + "`" + `main_pic` + "`" + ` 는 본 API에서 사용하지 않음 (대표사진은 ` + "`" + `/prf/set/mainpic` + "`" + `)\n- ` + "`" + `area` + "`" + `는 지역명 문자열 → 서버에서 area code로 변환\n\n**응답 data**: ` + "`" + `{\"msg\":\"success\"}` + "`" + `",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "description": "수정할 프로필 필드 (부분 업데이트)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/protocol.PrfInfo"
                        }
                    }
                ],
                "responses": {
        ...
        "/user/v01/set/{cate}/{value}": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Setting category (e.g. alert)",
                        "name": "cate",
                        "in": "path",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "protocol.CreateStoryReq": {
            ...
            "properties": {
                "media": {
                    "description": "story.str_img와 동일 슬롯 맵",
                    "allOf": [
                        {
                            "$ref": "#/definitions/protocol.StoryStrImg"
                        }
                    ]
                },
                "sbody": {
        ...
        "protocol.SetPrfPicStatReq": {
            "type": "object",
            "properties": {
                "slot": {
                    "description": "sub_pic1~5",
                    "type": "integer",
                    "example": 1
                },
                "uid": {
                    "type": "integer",
                    "example": 8697414060736839837
                }
            }
        },
        "protocol.StoryLikeToggleReq": {
            "type": "object",
            "properties": {
                "story_idx": {
                    "type": "string"
        ...
        "protocol.StoryMediaItem": {
            "type": "object",
            "properties": {
                "thumb": {
                    "description": "vdo only",
                    "type": "string",
                    "example": "https://imagedelivery.net/.../public"
                },
                "type": {
                    "description": "\"img\" | \"vdo\"",
                    "type": "string",
        ...
        "protocol.StoryStrImg": {
            "type": "object",
            "additionalProperties": {
                "$ref": "#/definitions/protocol.StoryMediaItem"
            }
        },
